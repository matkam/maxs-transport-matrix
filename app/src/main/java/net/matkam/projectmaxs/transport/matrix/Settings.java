...
//	private final String LAST_ACTIVE_NETWORK;
	private final String MATRIX_INTENT;
...
//				 context.getSharedPreferences(Constants.MAIN_PACKAGE, Context.MODE_PRIVATE);
...
//						XMPP_STREAM_COMPRESSION, XMPP_STREAM_ENCYPTION, XMPP_DEBUG }));
		...
		MATRIX_INTENT = context.getString(R.string.pref_app_matrix_intent_key);
		XMPP_INTENT_SHARED_TOKEN = context
				.getString(R.string.pref_app_matrix_intent_shared_token_key);
...
//	}
	...
	/**
	 *
	 * @return true if the Matrix intent is enabled
	 */
	public boolean isMatrixIntentEnabled() {
		return mSharedPreferences.getBoolean(MATRIX_INTENT, false);
	}

	/**
	 *
	 * @return the Matrix intent shared token or null
	 */
	public String getMatrixIntentSharedToken() {
